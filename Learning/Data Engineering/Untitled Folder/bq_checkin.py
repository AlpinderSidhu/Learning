...
with open('/Users/alsidhu/Downloads/archive/JSONL/yelp_academic_dataset_checkin.json', 'r') as jsonl_file:
    ...
    for line in jsonl_file:
        ...
        row = {
            ...
            "date": date,
            "checkin_data": json.dumps(data),  # Store the remaining data as JSON string
        }
