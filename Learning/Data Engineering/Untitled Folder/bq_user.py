...
with open('/Users/alsidhu/Downloads/archive/JSONL/yelp_academic_dataset_user.json', 'r') as jsonl_file:
    ...
    for line in jsonl_file:
        ...
        row = {
            "name": name,
            "user_id": user_id,
            "user_data": json.dumps(data),  # Store the remaining data as JSON string
        }
